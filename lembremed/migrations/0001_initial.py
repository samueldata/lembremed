# Generated by Django 5.0.3 on 2024-05-11 21:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': (('pode_gerenciar_instituicao', 'Pode gerenciar as instituições'),),
            },
        ),
        migrations.CreateModel(
            name='Morador',
            fields=[
                ...
                ('instituicao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lembremed.instituicao')),
            ],
            options={
